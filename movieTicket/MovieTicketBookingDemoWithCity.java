...
public class MovieTicketBookingDemoWithCity {
    public static void main(String[] args) {
        MovieTicketBookingSystemWithCity bookingSystem = MovieTicketBookingSystemWithCity.getInstance();

        // Add movies
        Movie movie1=bookingSystem.addMovie("M1", "Movie 1", "Description 1", 120);
        Movie movie2=bookingSystem.addMovie("M2", "Movie 2", "Description 1", 120);

        // ignoring rest of methods using city because it is not possible to implement the city functioanlity in interview due to time constraints
